...
?INIT:
    ...
    LXI H,8000H         ;SIGNIFIES DEVICE 0 (CRT:)
    ...
    LXI     H,4000H     ;SIGNIFIES DEVICE 1 (LPT:)
...
SIGNON$MSG:
    ...
    DB  '(Banked) CP/M V3.0'
    DB  CR,LF,'Z80-MBC2 BIOS Modules: S200918, S210918-R210923, '
    DB  'S220918-R210923, S290918,', CR,LF,' S170319'
    DB  CR,LF,LF,0
