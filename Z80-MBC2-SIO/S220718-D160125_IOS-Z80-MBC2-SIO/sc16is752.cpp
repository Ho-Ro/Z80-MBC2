...
void SC16IS752_Init(uint32_t baud_A, uint32_t baud_B) {
  ...
  SC16IS752_FIFOSetTriggerLevel(SC16IS752_CHANNEL_A, 0, 60);  // TX FIFO A
  SC16IS752_FIFOSetTriggerLevel(SC16IS752_CHANNEL_A, 1, 60);  // RX FIFO A
  SC16IS752_FIFOSetTriggerLevel(SC16IS752_CHANNEL_B, 0, 60);  // TX FIFO B
  SC16IS752_FIFOSetTriggerLevel(SC16IS752_CHANNEL_B, 1, 60);  // RX FIFO B
