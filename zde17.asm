...
;		[----5----10---15---20---25--]
VersID:	DB	'ZDE 1.7.1, (C) 1990 C.Wilson',0
;
;
...
DFMode:	DB	'N'	;default file modem W/A/N
...
DfltRM:	DB	99	;right margin column (1=OFF)
...
;
	ORG	180H
Z3tcap:	DB	'ANSI standard   '	;ID
	ORG	190H
View:	DB	120			;viewable columns (max 128)
AuWrap:	DB	0FFH			;does autowrap cursor
Lines:	DB	30			;lines
UsrKys:	DB	08H			;BS, DEL key
	DB	05H			;^E, arrow up
	DB	18H			;^X, arrow down
	DB	04H			;^D, arrow right
	DB	13H			;^S, arrow left
	DB	0
CIL:	DB	3,ESC,'[K',0,0,0	;199H: clear to end of line, 1+6 bytes
TInit:	DB	6,ESC,'[H',ESC,'[J',0	;1A0H: terminal init, 1+7 bytes
TUInit:	DB	6,ESC,'[H',ESC,'[J',0	;1A8H: terminal uninit, 1+7 bytes
AltOn:	DB	4,ESC,'[7m',0,0		;1B0H: alt video on, 1+6 bytes
AltOff:	DB	3,ESC,'[m',0,0,0	;1B7H: alt video off, 1+6 bytes
AltBit:	DB	0			;1BEH: high bit gives alt video?
Filter:	DB	7FH			;1BFH: highest ASCII to send to screen
PosMod:	DB	'A'			;1C0H: curpos mode (Std/Rev/ANSI/None)
PCu:	DB	3,ESC,'[H'		;1C1H: position cursor to (0,0) 1+3 bytes
PosDly:	DB	0			;1C5H: delay after curpos (00-FF)
InsL:	DB	3,ESC,'[L',0,0,0	;1C6H: insert line [1], 1+6 bytes
DelL:	DB	3,ESC,'[M',0,0,0	;1CDH: delete line [1], 1+6 byts
OddDel:	DB	0			;1D4H: ins/del line specific?
CsrOff:	DB	3,ESC,';A',0,0,0	;1D5H: cursor off, 1+6 bytes
CurOn:	DB	3,ESC,';I',0,0,0	;1DCH: cursor on, 1+6 bytes
;
